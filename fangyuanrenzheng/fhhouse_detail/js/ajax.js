...
//			console.log(prcvinceJsons.imageList[i].image);
			document.getElementById("part1_spic"+(i+1)).src = web_url+prcvinceJsons.imageList[i].image;
		}
//		document.getElementById("part1_spic"+(i+1))
		document.getElementById("part1_bpic").src = web_url+prcvinceJsons.imageList[0].image;
...
// 	   	var part2_name_block = 'part2_name'+i;
        ...
        document.getElementById(part2_a_block).style.display = "block";
   	   	...
   	   	document.getElementById(part2_f_block).src = web_url+ part2_img[i-1];
 	...
 	if(id==3){
       ...
       document.getElementById('part3_hxt').src = web_url+part3_img[0];
	...
	if(id=5){
		document.getElementById("part5_img").src = web_url+prcvinceJsons.bus;
	}
 	if(id==6){
       document.getElementById('lpmc').innerHTML = prcvinceJsons.building_name;
       document.getElementById('lpdz').innerHTML = prcvinceJsons.building_address;
