...
window.onload = function(){
 ...
 function focbtn(id){	
	partnow=id;
	if(id==1){
		document.getElementById('wancheng').src= 'image_shenghuojiaofei/27.png';
	}
	if(id==2){
...
function blubtn(id){
	if(id==1){
		document.getElementById('wancheng').src= 'image_shenghuojiaofei/26.png';
	}
	if(id==2){
...
function kpress(){          
 ...
 function wancheng(){
 	window.location.href = 'shenghuojiaofei_zhangdan_index.html'
 }