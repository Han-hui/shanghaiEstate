...
function Ajax11(){
            getStr = "http://192.168.200.46:8170/api/HouseAgency?offset="+ye+"&limit=" + lastCount;
...
function Ajax1(){
            getStr = "http://192.168.200.46:8170/api/HouseAgency?address='武东路198号'&select=1&offset="+ye+"&limit=3";
            xmlhttp=new XMLHttpRequest();
            xmlhttp.open("get",getStr, true);
            xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xmlhttp.send();
